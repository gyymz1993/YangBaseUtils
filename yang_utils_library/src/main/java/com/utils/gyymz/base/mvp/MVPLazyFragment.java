...
import com.utils.gyymz.base.lazy.BaseLazyFragment;
 ...
 * {@link #isLazyLoad()}方法。
 */
public abstract class MVPLazyFragment<P extends BasePresenterImpl> extends
        BaseLazyFragment implements BaseView, OnTitleBarListener {
