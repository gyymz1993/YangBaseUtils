...
public class VaryViewHelper implements IVaryViewHelper {
    ...
    public VaryViewHelper(View view) {
        ...
        this.selfParams = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
    }
    ...
    private void init() {
        ...
        if (originalView.getParent() != null) {
            ...
            parentView = originalView.getRootView().findViewById(android.R.id.content);
        }
