package com.view.utils.DatePicker;
...
public class DatePickerUtils {
    ...
    private CusDatePickerView year_pv, month_pv, day_pv, hour_pv, minute_pv;
    ...
    public DatePickerUtils(Context context, ResultHandler resultHandler, String startDate, String endDate) {
    ...
    private void initDialog() {
        if (datePickerDialog == null) {
            ...
            datePickerDialog.setContentView(R.layout.layout_custom_date_picker);
    ...
    private void addListener() {
        year_pv.setOnSelectListener(new CusDatePickerView.onSelectListener() {
            @Override
        ...
        month_pv.setOnSelectListener(new CusDatePickerView.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        day_pv.setOnSelectListener(new CusDatePickerView.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        hour_pv.setOnSelectListener(new CusDatePickerView.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        minute_pv.setOnSelectListener(new CusDatePickerView.onSelectListener() {
            @Override
            public void onSelect(String text) {
