...
public class BaseRecyclerHolder extends RecyclerView.ViewHolder {
    ...
    public BaseRecyclerHolder setAdapter(@IdRes int viewId, Adapter adapter) {
     ...
     * @return The BaseViewHolder for chaining.
     */
    protected BaseRecyclerHolder setAdapter(BaseRvAdapter adapter) {
     ...
     */
    @SuppressWarnings("unchecked")
    public BaseRecyclerHolder addOnClickListener(@IdRes final int viewId) {
     ...
     * @return
     */
    public BaseRecyclerHolder setNestView(@IdRes int viewId) {
     ...
     */
    @SuppressWarnings("unchecked")
    public BaseRecyclerHolder addOnLongClickListener(@IdRes final int viewId) {
