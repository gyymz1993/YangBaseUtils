...
public abstract class LoadMoreView {
    ...
    private void visibleLoading(BaseRecyclerHolder holder, boolean visible) {
        holder.setVisible(getLoadingViewId(), visible);
    }

    private void visibleLoadFail(BaseRecyclerHolder holder, boolean visible) {
        holder.setVisible(getLoadFailViewId(), visible);
    }

    private void visibleLoadEnd(BaseRecyclerHolder holder, boolean visible) {
