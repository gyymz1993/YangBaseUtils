...
public interface ILoadViewFactory {
    ...
    interface ILoadView {
         ...
         */
        void init(View switchView, ViewRefreshListener onClickRefreshListener);
        ...
        void onRefreshListenerView(ViewRefreshListener onClickRefreshListener);
    }
    ...
    interface ILoadMoreView {
         ...
         */
        void init(View rootView, ViewRefreshListener onClickLoadMoreListener);
