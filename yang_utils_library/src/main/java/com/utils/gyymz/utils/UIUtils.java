...
public class UIUtils {
    ...
    public static Context getContext() {
        return BaseApplicationCompat.getApplication();
    }

    public static Thread getMainThread() {
        return BaseApplicationCompat.getMainThread();
    }

    public static long getMainThreadId() {
        return BaseApplicationCompat.getMainThreadId();
    }
    ...
    //获取状态栏的高度
    public static int getstatusBarColorHeight(Context context) {
    ...
    public static Handler getHandler() {
        Log.e("BaseApplicationCompat", BaseApplicationCompat.class.getName());
        return BaseApplicationCompat.getMainThreadHandler();
    }
    ...
    public void satusBarColor(Activity activity, int color) {
        //SystemBarHelper.tintstatusBarColor(activity, color);
    }
    ...
    private static Bitmap takeShot(Activity activity) {
        ...
        int statusBarColorHeight = outRect.top;

        //状态栏+标题栏目的高度
        statusBarColorHeight = activity.getWindow().findViewById(Window.ID_ANDROID_CONTENT).getTop();

        //屏幕宽高
        int height = getScreenHeightPixels(activity);
        int width = getScreenWidthPixels(activity);

        // 如果需要状态栏,则使用 Bitmap b = Bitmap.createBitmap(view.getDrawingCache(), 0, 0, width, height - statusBarColorHeight);
        Bitmap b = Bitmap.createBitmap(view.getDrawingCache(), 0, statusBarColorHeight, width, height - statusBarColorHeight);
        // 销毁缓存信息
